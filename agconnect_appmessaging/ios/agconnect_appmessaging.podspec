...
Pod::Spec.new do |s|
  ...
  s.version          = '1.9.0+300'
  s.summary          = 'Flutter plugin for AppGallery Connect App Messaging SDK.'
  s.description      = <<-DESC
  Flutter plugin for AppGallery Connect App Messaging SDK.
                       DESC
  ...
  s.dependency 'AGConnectAppMessaging' ,'~> 1.9.4.300'
  s.platform = :ios, '9.0'
